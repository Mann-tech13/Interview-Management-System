...
import "../../assets/CSS/Admin/AdminHR.css"
import AddHR from '../Forms/AddHR';


function UserHRContent() {
    ...
    return (
        <div className="candidate-container">
            ...
            <div className="">
                {formVisible && <AddHR visible={formVisible} setVisible={setFormVisible} />}
            </div>
        </div>
    )
}

export default UserHRContent